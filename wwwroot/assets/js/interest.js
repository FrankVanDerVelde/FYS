...
async function getUsersWithInterests(agesFilter, genderFilter) {
    ...
    try {
      ...
      //  console.log(queryStrings.join(' '));
        ...
        for (let i = 0; i < userList.length; i++) {
            userInterests.push({user: userList[i], userInterests: await getUserInterests(userList[i].id)});
        }
        
       // await calcPercentage(userInterests[0].userInterests, userInterests[1].userInterests)
