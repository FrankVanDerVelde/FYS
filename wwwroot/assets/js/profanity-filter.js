...
let testMessage = 'Je hoeren moeder is een dikke tyfus hoer';
...
// Use this function when you want to check for the existance of profanity and then do something
function containsProfanity(message) {
    // Not using for each because for each doesn't allow early termination using a return
    for (let i = 0; i < profanityList.length; i++) {
        console.log(message);
        console.log(profanityList[i]);
...
console.log(censorProfanity(testMessage));

console.log(containsProfanity(testMessage));
...
//     const profanity = [];
//     document.querySelectorAll(".mw-category-group>ul>li>a").forEach(element => {
//         profanity.push(element.innerHTML);
//     })
